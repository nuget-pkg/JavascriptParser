...
[AutoGeneratedAstVisitor(VisitorType = typeof(IJsxAstVisitor), TargetVisitorFieldName = nameof(_visitor))]
public partial class JsxAstVisitor : AstVisitor, IJsxAstVisitor
{
    ...
    {
        return new JsxAstVisitor(visitor ?? ThrowArgumentNullException<AstVisitor>(nameof(visitor)));
    }
