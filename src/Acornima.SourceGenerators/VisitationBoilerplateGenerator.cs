...
{
    private const string NodeTypeName = "JavascriptParser.Ast.Node";
    private const string NodeCSharpTypeName = "JavascriptParser.Ast.Node";

    private const string NodeListOfTTypeName = "JavascriptParser.Ast.NodeList`1";
    private const string NodeListOfTCSharpTypeName = "JavascriptParser.Ast.NodeList<>";

    private const string ChildNodesEnumeratorTypeName = "JavascriptParser.Ast.ChildNodes+Enumerator";
    private const string ChildNodesEnumeratorCSharpTypeName = "JavascriptParser.Ast.ChildNodes.Enumerator";

    private const string AstVisitorTypeName = "JavascriptParser.AstVisitor";
    private const string AstVisitorCSharpTypeName = "JavascriptParser.AstVisitor";
    ...
    private static VisitableNodeInfo? GetVisitableNodeInfo(GeneratorSyntaxContext context, CancellationToken cancellationToken)
    {
        ...
        if (classType is null
            ...
            || attribute.AttributeClass.ContainingNamespace.ToString() != "JavascriptParser.Ast"
